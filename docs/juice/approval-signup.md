...
「承認式新規登録」は、新規登録の際に登録理由の入力を必須とし、管理者が内容を確認した上で承認する、JUICE独自の機能です。**Juice Serverでは現在この機能を使用していないため、誰でも登録するだけですぐにアカウントを使い始められます。** 以下は、この機能が有効な場合(自ホストインスタンスなど)の流れの説明です。
