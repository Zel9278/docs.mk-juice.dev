...
flowchart TD
    ...
    C --> D{管理员进行审核}
    D -->|批准| E["`可以登录<br/>**(批准通知邮件)**`"]
    D -->|驳回| F["`驳回通知<br/>**需要重新注册**`"]
```
...
- **获得批准时**: 您将可以登录。若已注册并验证电子邮箱地址,还会收到批准通知邮件。
- **被驳回时**: 您将收到通知。若想再次申请,请以新账号重新注册(被驳回的申请本身无法恢复)。
...
请参阅[关于本服务器的运营方针](../about-juice-server.md)。
