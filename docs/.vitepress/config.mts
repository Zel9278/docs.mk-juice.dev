...
const jaSidebar = [
	...
	},
	{
		...
		items: [
			...
			{ text: "MIDIプレイヤー", link: "/juice/midi-player" },
			...
			{ text: "通報", link: "/juice/abuse-report" },
...
const enSidebar = [
	...
	},
	{
		...
		items: [
			...
			{ text: "MIDI player", link: "/en/juice/midi-player" },
			{ text: "Media timeline", link: "/en/juice/media-timeline" },
			...
			{ text: "LaTeX (math) rendering", link: "/en/juice/latex" },
				...
				{ text: "Abuse reports", link: "/en/juice/abuse-report" },
...
const koSidebar = [
	...
	},
	{
		...
		items: [
			...
			{ text: "MIDI 플레이어", link: "/ko/juice/midi-player" },
			...
			{ text: "LaTeX(수식) 표시", link: "/ko/juice/latex" },
				...
				{ text: "신고", link: "/ko/juice/abuse-report" },
...
const zhHansSidebar = [
	...
	},
	{
		...
		items: [
			...
			{ text: "MIDI 播放器", link: "/zh-hans/juice/midi-player" },
			...
			{ text: "LaTeX(数学公式)显示", link: "/zh-hans/juice/latex" },
				...
				{ text: "举报", link: "/zh-hans/juice/abuse-report" },
...
const zhHantSidebar = [
	...
	},
	{
		...
		items: [
			...
			{ text: "MIDI 播放器", link: "/zh-hant/juice/midi-player" },
			...
			{ text: "LaTeX(數學公式)顯示", link: "/zh-hant/juice/latex" },
				...
				{ text: "檢舉", link: "/zh-hant/juice/abuse-report" },
